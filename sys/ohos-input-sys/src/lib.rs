...
#[doc = " @brief Input_TouchEventToolType\n @since 24"]
#[cfg(feature = "api-24")]
...
extern "C" {
    #[doc = " @brief Obtains the tool type of a touch event.\n\n @param touchEvent Touch event object.\n @return toolType.\n @since 24"]
    #[cfg(feature = "api-24")]
