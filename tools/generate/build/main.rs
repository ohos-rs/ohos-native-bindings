...
static CONFIG: Lazy<Vec<Lazy<SysConfig>>> = Lazy::new(|| {
    vec![
        ...
        config::USB_SERIAL,
        config::ABILITY_BASE,
        config::ABILITY_RUNTIME,
        config::CHILD_PROCESS,
        config::BACKGROUND_PROCESS_MANAGER,
        config::COMMON_EVENT,
        config::BATTERY_INFO,
        config::PRINT,
        config::SCAN,
        config::OS_ACCOUNT,
        config::TIME_SERVICE,
        config::NATIVE_COLOR_SPACE_MANAGER,
        config::BLUETOOTH,
        config::WIFI,
        config::CONTENT_EMBED,
        config::DLP_PERMISSION,
        config::DEVICE_CERTIFICATE,
        ...
        config::LOCATION,
        config::MINDSPORE,
        config::MULTIMODAL_INPUT,
        config::NATIVE_EFFECT,
        config::NATIVE_FENCE,
        config::NATIVE_IMAGE,
        config::NNRT,
        config::NOTIFICATION,
        config::AUDIO_SUITE,
        config::OHMIDI,
        config::PURGEABLE_MEMORY,
        config::TEE_CLIENT,
        config::TELEPHONY,
        config::TRANSIENT_TASK,
    ]
});
...
fn declaration_key(
    ...
    if let Some(cap) = static_re.captures(trimmed) {
    ...
    if let Some(cap) = self_alias_re.captures(trimmed) {
